...
class Penjualan extends CI_Controller {
    ...
    public function proses_tambah(){
        $jumbah_barang_dibeli=count($this->input->post('nama_barang_hidden'));
        ...
        for($i=0; $i < $jumlah_barang_dibeli ; $i++) {
            array_push($data_detail_penjualan,['nama_barang'=>$this->input->post('nama _barang_hidden')[$i]]);
        ...
        if($this->penjualan->tambah($data_penjualan) && $this->m_detail_penjualan->tambah($data_detail_penjualan)){
            for($i=0; $i < $jumlah_barang_dibeli ; $i++) {
                $this->m_barang->min_stok($data_detail_penjualan[$i]['jumlah_barang'], $data_detail_penjualan[$i]['nama_barang'])
    ...
    public function detail($no_penjualan){
        ...
        $this->data->view('penjualan/detail', $this->data);
    }
